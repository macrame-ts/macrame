...
// measure/median/report + Clock/target/reps/warmup come from bench_harness.h.
namespace
{
...
// docs/coroutine-first.md Â§5.1). Target: at or below `launch` above.
...
// equivalent of the `then` chain benchmark below (the number to beat, Â§5.5).
...
// actually dominated by - see docs/pipe-rebase.md Â§0.4.
