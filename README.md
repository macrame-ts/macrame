...
- **`parallel_for`** — for the data-parallel work that does live inside a part; caller-participating (nested-safe) and self-balancing. Plus **`parallel_for_async`** and **`parallel_for_colored`** for extra flexibility.
