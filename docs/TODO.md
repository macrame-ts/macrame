...
1. **Guarded / access**
   ...
   *Standing priority (author, 2026-07): anything that strengthens the harness
   ...
   8. `[ ]` **(P1) `Access_options` vs `Launch_options`** — revisit whether the two option aggregates share a base or stay split (flagged in `task.h`); resolve in the code-review API-stability pass.
