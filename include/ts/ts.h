...
#include "ts/version.h"            // TS_VERSION_* macros, ts::version_major/minor/patch, version_string()
...
#include "ts/recorder.h"           // ts::Recorder<T>, ts::Parallel_recorder<T> - the staging handles
